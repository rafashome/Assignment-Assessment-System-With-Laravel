...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar" data-color="purple" data-image="assets/img/sidebar-5.jpg">
            ...
            <div class="sidebar-wrapper">
              ...
              <ul class="nav">
                ...
                <ul class="dropdown-menu" style="margin-left: 25px; color:#222;">
                    <li ><a href="{{URL('add-teacher')}}" style="color:#222;">Add Teacher</a></li>
                    <li ><a href="{{URL('teacherlist')}}" style="color:#222;">Teacher's List</a></li>
            ...
            <ul class="dropdown-menu" style="margin-left: 25px; color:#222;">
                <li ><a href="{{URL('add-student')}}" style="color:#222;">Add Student</a></li>
                <li ><a href="{{URL('studentlist')}}" style="color:#222;">Student's List</a></li>
        ...
        <li class="dropdown" >
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <i class="pe-7s-user"></i>
            <p>  Course <b class="caret"></b> </p>
        </a>
        <ul class="dropdown-menu" style="margin-left: 25px; color:#222;">
            <li ><a href="{{URL('add-course')}}" style="color:#222;">Add Course</a></li>
            <li ><a href="{{URL('courselist')}}" style="color:#222;"> Course List</a></li>
