          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{'/students_view/'.$row->id}}"><button type="button" class="btn btn-primary">View</button></a>

                <a data-href="{{url('/student_delete/'.$row->id)}}" data-toggle="modal" data-target="#delete"><button  type="button" class="btn btn-danger ">Delete</button></a>
              </td>
